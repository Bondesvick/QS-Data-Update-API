...
using QSDataUpdateAPI.Domain.Services.RedboxServiceProxies;
using QSDataUpdateAPI.Domain.Services.RedboxServiceProxies.Interfaces;

namespace IBranch.API.Helpers.Extensions
{
    public static class StartupConfigExtensions
    {
        ...
        {
            options.SwaggerDoc("QuickService_Data_Update_v1", new Microsoft.OpenApi.Models.OpenApiInfo
            {
                Title = "QuickService Data Update API",
                Version = "v1",
                Description = "API Docs QuickService Data Update"
            });
        ...
        {
            options.SwaggerEndpoint("./swagger/QuickService_Data_Update_v1/swagger.json", " QuickService Data Update API Docs");
        ...
        public static IServiceCollection ConfigureApplicationCoreServices(this IServiceCollection services)
        {
            ...
            services.AddScoped<IRepository<DataUpdateDetails, int>, BaseEFRepository<DataUpdateDetails, int>>();
